...
typedef NS_ENUM(NSInteger, ELDEVICECLASSTYPE) {
    ...
    ELDEVICECLASSTYPE_KPL_DOORSENSOR=37,//KPL门磁
    ELDEVICECLASSTYPE_KPL_MOTIONDET,//KPL红外感应器
    ELDEVICECLASSTYPE_KPL_DOORBELL,//KPL门铃
    ELDEVICECLASSTYPE_KPL_SMOKE_DETECTOR,//KPL烟雾报警器
    ELDEVICECLASSTYPE_KPL_GAS_DETECTOR,//KPL燃气报警器
